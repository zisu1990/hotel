    ...
    <el-main>
      <el-row>
        <el-col :offset="3" :span="18">
          ...
          <el-form ref="formShifWorkPage" :model="formShifWorkPage" label-width="130px">
            <el-row type="flex" justify="space-between">
              <el-col :span="7">
                <el-form-item label="交班人：">
                  <el-input disabled v-model="formShifWorkPage.shifUserName"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="7">
                <el-form-item label="接班现金额(元)：">
                  <el-input disabled v-model="formShifWorkPage.carryOnMoney"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="7">
            ...
            <el-row type="flex" justify="space-between">
              <el-col :span="7">
                <el-form-item label="接班人：">
                  <el-select v-model="formShifWorkPage.userOnName" clearable filterable>
                    <el-option label="张三" key="zhangsan" value="zhangsan"></el-option>
              ...
              <el-col :span="7">
                <el-form-item label="接班现金额(元)：">
                  <el-input clearable v-model="formShifWorkPage.userOnMoney"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="7">
            ...
            <el-row style="margin-top: 30px">
              <el-form-item>
                ...
                <el-button style="width: 100px" size="medium" type="primary">打印</el-button>
              </el-form-item>
            </el-row>
          </el-form>
        </el-col>
