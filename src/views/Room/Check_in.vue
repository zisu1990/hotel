<template>
  <el-container>
    <el-main>
      ...
      <div class="checkWarp">
        ...
        >
          ...
          <el-row :gutter="20" type="flex" justify="left">
            <el-col :span="8">
              <el-form-item label="房费总金额（元）：">
                <el-input
                  v-model="checkInForm.RoomSumMoney"
                  disabled
                  :style="{ width: '100%' }"
                ></el-input>
              </el-form-item>
            ...
            <el-col :span="8">
              <el-form-item label="已付预款（元）：">
                <el-input
                  v-model="checkInForm.advancePay"
                  :style="{ width: '100%' }"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20" type="flex" justify="left">
            ...
            <el-col :span="8">
              <el-form-item label="预付金额（元）：">
                <el-input
                  v-model="checkInForm.advanceMoney"
                  :style="{ width: '100%' }"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20" type="flex" justify="left">
            ...
            <el-col :span="8">
              <el-form-item label="卡扣金额（元）：">
                <el-input
                  v-model="checkInForm.cardPayfor"
                  :style="{ width: '100%' }"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20" type="flex" justify="center" class="btn">
            ...
            <el-button type="primary" @click="GateCardDialogVisible = true"
              >确认</el-button
            >
          </el-row>
        </el-form>
      ...
      <el-dialog
        title="住客登记查询"
        :visible.sync="ResidentsDialogVisible"
        width="50%"
        center
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="ResidentsDialogVisible = false"
            >确 定</el-button
          >
        </span>
      </el-dialog>
      ...
      <el-dialog
        title="门卡写入"
        :visible.sync="GateCardDialogVisible"
        width="50%"
        center
      >
      ...
      <el-dialog
        title="预付款单"
        :visible.sync="payforDialogVisible"
        width="50%"
      >
        <ul class="payForList">
          <li>
