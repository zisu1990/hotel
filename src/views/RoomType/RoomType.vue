<template>
  <el-container>
    <el-main>
            ...
            <el-table-column label="状态">
              <template v-slot="scope">
                <el-switch v-model="scope.row.status" :active-value="1" :inactive-value="0" active-color="#13ce66"
                  inactive-color="#999" @change="handleChangeSwich(scope.row.status, scope.row.id)"></el-switch>
              </template>
            </el-table-column>
      ...
      <el-dialog title="新房间类型" :visible.sync="dialogVisible" @closed="cleranFormRoomType" width="28%">
        <el-row type="flex" justify="center">
          <el-col :span="18">
            <el-form :rules="rules" :model="formRoomType" ref="formRoomType" label-width="100px">
              <el-form-item prop="name" label="房间类型：">
                <el-input clearable v-model="formRoomType.name" placeholder="请输入房间类型"></el-input>
              </el-form-item>
              <el-form-item prop="price" label="房间价格：">
                <el-input clearable v-model="formRoomType.price" placeholder="请输入房间价格"></el-input>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
      ...
      <el-dialog title="编辑房间类型" :visible.sync="dialogVisibleEdit" width="28%" @closed="cleranFormRoomTypeEdit">
        <el-row type="flex" justify="center">
          <el-col :span="18">
            <el-form :rules="rules" :model="formRoomTypeEdit" ref="formRoomTypeEdit" label-width="100px">
              <el-form-item prop="name" label="房间类型：">
                <el-input clearable v-model="formRoomTypeEdit.name" placeholder="请输入房间类型"></el-input>
              </el-form-item>
              <el-form-item prop="price" label="房间价格：">
                <el-input clearable v-model="formRoomTypeEdit.price" placeholder="请输入房间价格"></el-input>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
